...
DEFAULT_STREAK_MESSAGES = {
    ...
    "win_streak": {
        ...
        "4": "🔥 4 WINS SEGUIDAS woof woof",
        "5": "🔥 5 WINS (IMPARABLE) WOOF WOOF",
        "6": "🔥 6 WINS WTF",
        "7": "🔥 7 WINS (SMURF DETECTED) JustBidness",
        "8": "🔥 8 WINS (MONSTRUO) tuh",
        "9": "🔥 9 WINS (INHUMANO) IreliaPray",
        "10": "🔥 10 WINS (DIOS) ShinWIN",
        "11": "🔥 11 WINS (NO FALLA) dog",
        "12": "🔥 12 WINS (MODO DIABLO) irelia",
        "13": "🔥 13 WINS (ESTÁ ROTO) Dance",
        "14": "🔥 14 WINS (NO ES NORMAL) dickface",
        "15": "🔥 15 WINS (DESTRUIDO) :33",
        "16": "🔥 16 WINS (LOBBY DIFF) agurinthuglife",
        "17": "🔥 17 WINS (SIN SENTIDO) BOOMIES",
        "18": "🔥 18 WINS (HACK?) sendoKUM",
        "19": "🔥 19 WINS (ESTO ES ILEGAL) NERD",
